...
<link rel="stylesheet" href="https://cedricvb.be/wp-content/pages/xslt/catalog.css">
        ...
        <body>  
            <h2  style="color:black;text-align:;" ><i>Item City Wise</i></h2>
			<div class="container" style= "max-width:1250px;background-color:">
              ...
              <xsl:for-each select="root/item">
			       <tr>
			<td style="padding-right:30px;border-top: 2px solid darkturquoise;border-right: 1px solid darkturquoise;text-align:right;background-color: ;"><xsl:value-of select = "Date"/></td>   
