...
xmlns:xsl = "http://www.w3.org/1999/XSL/Transform">  
   ...
   <xsl:template match = "/">   
      ...
      <html>   
	     <head>
		<title>Category City Wise Year</title>
        ...
        <body>  
            <h2  style="color:black;text-align:;" ><i>Category City Wise Year</i></h2>
			<div class="container" style= "max-width:1250px;background-color:">
              ...
              <xsl:for-each select="root/item">
			       <tr >
						...
						<td style="padding-right:30px;border-top: 2px solid darkturquoise;border-right: 1px solid darkturquoise;text-align:left;background-color:;" ><xsl:value-of select = "City_Name"/></td>  
