...
xmlns:xsl = "http://www.w3.org/1999/XSL/Transform">  
   ...
   <xsl:template match = "/">   
	   ...
	   <html>   
        ...
        <body>  
            <h2  style="color:black;text-align:;" ><i>Inward Collection </i></h2>
			<div class="container" style= "max-width:1250px;background-color:">
				...
				<tr >   
					...
					<th  style="color:black;text-align: center;background:darkturquoise;Font-size:15px;" >Seller_Type</th>   
					...
					<th  style="color:black;text-align: center;background:darkturquoise;Font-size:15px;" >Is_Direct</th>
					<th  style="color:black;text-align: center;background:darkturquoise;Font-size:15px;" >WH_ID</th>  
              ...
              <xsl:for-each select="root/item">
			       <tr>
						...
						<td style="padding-right:30px;border-top: 2px solid darkturquoise;border-right: 1px solid darkturquoise;text-align:left;background-color: ;" ><xsl:value-of select = "Seller_Type"/></td>   
						...
						<td style="padding-right:30px;border-top: 2px solid darkturquoise;border-right: 1px solid darkturquoise;text-align:left;background-color:;"><xsl:value-of select = "Is_Direct"/></td>
						<td style="padding-right:30px;border-top: 2px solid darkturquoise;border-right: 1px solid darkturquoise;text-align:left;background-color:;"><xsl:value-of select = "WH_ID"/></td>
