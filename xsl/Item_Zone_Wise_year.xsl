...
xmlns:xsl = "http://www.w3.org/1999/XSL/Transform">  
   ...
   <xsl:template match = "/">   
      ...
      <html>   
	     <head>
		<title>Item Zone Wise year</title>
        ...
        <body>  
            <h2  style="color:black;text-align:;" ><i>Item Zone Wise year</i></h2>
			<div class="container" style= "max-width:1250px;background-color:">
				 <t <table class="table table-bordered table-striped table-hover"  style="background-color:#fff;border:2px;font-family:Times;">   
				<tr >   
