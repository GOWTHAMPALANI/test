...
xmlns:xsl = "http://www.w3.org/1999/XSL/Transform">  
   ...
   <xsl:template match = "/">   
      ...
      <html>   
	     <head>
		<title>Category City Wise</title>
        ...
        <body>  
            <h2  style="color:black;text-align:;" ><i>Category City Wise</i></h2>
			<div class="container" style= "max-width:1250px;background-color:">
              ...
              <xsl:for-each select="root/item">
			   <tr >
					 ...
					 <td style="border-top: 2px solid darkturquoise;border-right: 1px solid darkturquoise;text-align:right;background-color:;"><xsl:value-of select = "Min_Price"/></td>
					 <td style="border-top: 2px solid darkturquoise;border-right: 1px solid darkturquoise;text-align:right;background-color:;"><xsl:value-of select = "MAX_Price"/></td>
					 
					  <td style="border-top: 2px solid darkturquoise;border-right: 1px solid darkturquoise;text-align:left;background-color:;"><xsl:value-of select = "Managed_By"/></td>
